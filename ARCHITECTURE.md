...
- Transcript mode sessions use conversation-owned lifecycle records with compare-and-swap revisions. Startup interrupts every record left active before database readiness, preserving its last confirmed activity while leaving an unknown end time unset. See [`assistant/docs/mode-sessions.md`](assistant/docs/mode-sessions.md).
